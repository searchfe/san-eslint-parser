...
const EXCEPTIONS = new Set([
    ...
    // It cannot fix the behavior in san-eslint-parser side.
    "eol-last",
    "max-len",
    "max-lines",
...
/**
 * Modify the given test pattern to test with san-eslint-parser.
 *
...
function modifyPattern(ruleId, pattern) {
    ...
    // object), we cannot rewrite the test case with `san-eslint-parser`.
    if (
        pattern.parser != null ||
